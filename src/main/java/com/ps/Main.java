...
public class Main {
        ...
        while (displayBooks) {
            ...
            switch (choice) {
                case "A":
                    ...
                    break;
                case "B":
                    showCheckOutBooks(inventory, scanner);
                default:
    ...
    private static void showAvailableBooks(ArrayList<Book> inventory, Scanner scanner) {
        System.out.println("\nAvailable Books:");
           for(Book book : inventory) {
               if (!book.isCheckedOut()) {
                   System.out.println("ID: " + book.getBookId() + ", Title: " + book.getBookTitle() + ", ISBN: " + book.getBookIsbn());
               }
           }
